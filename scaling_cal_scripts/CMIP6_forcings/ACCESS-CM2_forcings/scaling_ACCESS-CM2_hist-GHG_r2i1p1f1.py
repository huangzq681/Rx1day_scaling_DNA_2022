...
def month2daily(month_file,ys,ye):
    ...
    var_main   = month_data.attrs['variable_id']
    month_data = month_data[var_main].sel(time=slice(str(ys),str(ye)))
...
src_id   = 'ACCESS-CM2'                                                                                                                                 ## *****
exp_id   = 'hist-GHG' #['historical','hist-aer','hist-GHG','hist-nat','piControl','ssp585']                                                             ## *****
var_lbl  = 'r2i1p1f1'                                                                                                                                   ## *****
grid_lbl = 'gn'
yearS    = [1950,1955,1960,1965,1970,1975,1980,1985,1990,1995,2000,2005,2010]                                                                           ## *****
yearE    = [1954,1959,1964,1969,1974,1979,1984,1989,1994,1999,2004,2009,2014]    
...
def getFilepath2(var,src_id,exp_id,var_lbl,grid_lbl):
    filePath = 'rawData/forcings/' + var_name[var]+'_'+freq[var]+'_'+src_id+'_'+ exp_id+'_'+ var_lbl+'_'+grid_lbl+'_'+'185001-'+'202012.nc'                      ## *****
    return filePath
...
# def getFilepath1(var,src_id,exp_id,var_lbl,grid_lbl,ys,ye):
#     filePath = '/Users/zeqinhuang/Documents/paper/prec_scaling_da/scaling_script/forcings/forcings_scripts_2nd/ACCESS-CM2_forcings/demodata/' + var_name[var]+'_'+freq[var]+'_'+src_id+'_'+ exp_id+'_'+ var_lbl+'_'+grid_lbl+'_'+str(ys)+'0101-'+str(ye)+'1231.nc'
#     return filePath

# def getFilepath2(var,src_id,exp_id,var_lbl,grid_lbl):
#     filePath = '/Users/zeqinhuang/Documents/paper/prec_scaling_da/scaling_script/forcings/forcings_scripts_2nd/ACCESS-CM2_forcings/demodata/' + var_name[var]+'_'+freq[var]+'_'+src_id+'_'+ exp_id+'_'+ var_lbl+'_'+grid_lbl+'_'+'185001-'+'202012.nc'                      ## *****
#     return filePath

# def writeFilepath(var,src_id,exp_id,var_lbl,ys,ye):
#     filePath = '/Users/zeqinhuang/Documents/paper/prec_scaling_da/scaling_script/forcings/forcings_scripts_2nd/ACCESS-CM2_forcings/demodata/'+src_id+'/' + var_name2[var]+'_'+'day'+'_'+src_id+'_'+ exp_id+'_'+ var_lbl+'_'+str(ys)+'-'+str(ye)+'.nc'                         ## *****
#     return filePath

# def writeFilepath2(var,src_id,exp_id,var_lbl,ys,ye):
#     filePath = '/Users/zeqinhuang/Documents/paper/prec_scaling_da/scaling_script/forcings/forcings_scripts_2nd/ACCESS-CM2_forcings/demodata/'+src_id+'/' + var +'_'+'day'+'_'+src_id+'_'+ exp_id+'_'+ var_lbl+'_'+str(ys)+'-'+str(ye)+'.nc'                                   ## *****
#     return filePath
...
# def getFilepath_pr():
#     filePath = '/Users/zeqinhuang/Documents/paper/prec_scaling_da/scaling_script/forcings/forcings_scripts_2nd/ACCESS-CM2_forcings/demodata/pr_day_ACCESS-CM2_hist-aer_r1i1p1f1_gn_19500101-20141231.nc'
#     return filePath

# def getFilepath_tas():
#     filePath = '/Users/zeqinhuang/Documents/paper/prec_scaling_da/scaling_script/forcings/forcings_scripts_2nd/ACCESS-CM2_forcings/demodata/tas_day_ACCESS-CM2_hist-aer_r1i1p1f1_gn_19500101-20141231.nc'
#     return filePath
...
if __name__ == "__main__":
    ...
    for i in range(len(yearS)):
        ...
        for k in range(yearS[i],yearE[i]+1):
            ...
            ps_daily = month2daily(ps_File, k, k)
