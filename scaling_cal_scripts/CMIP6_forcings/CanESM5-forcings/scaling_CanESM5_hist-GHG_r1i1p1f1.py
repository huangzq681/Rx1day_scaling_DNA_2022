...
def get_omega_aveTime():
    ...
    wap_alltime_cond_wp      = 'procData/DAmip/'+src_id+'/wap_alltime_cond_'+src_id + '_' + exp_id + '_' + var_lbl+'_'+str(yearS[0])+'-'+str(yearE[-1])+'.nc'
    ...
    wap_avgtime_cond_wp      = 'procData/DAmip/'+src_id+'/wap_avgtime_cond_'+src_id + '_' + exp_id + '_' + var_lbl+'_'+str(yearS[0])+'-'+str(yearE[-1])+'.nc'
...
yearE    = [1960,1970,1980,1990,2000,2010,2014]
dataTime = [str(ys)+'0101-'+str(ye)+'1231' for ys,ye in zip(yearS,yearE)]

def getFilepath1(var,src_id,exp_id,var_lbl,grid_lbl,ys,ye):
    filePath = 'rawData/forcings/' +src_id+'/'+ var_name[var]+'_'+freq[var]+'_'+src_id+'_'+ exp_id+'_'+ var_lbl+'_'+grid_lbl+'_'+str(ys)+'0101-'+str(ye)+'1231.nc'
    return filePath

def getFilepath2(var,src_id,exp_id,var_lbl,grid_lbl):
    filePath = 'rawData/forcings/' +src_id+'/'+ var_name[var]+'_'+freq[var]+'_'+src_id+'_'+ exp_id+'_'+ var_lbl+'_'+grid_lbl+'_'+'185001-'+'202012.nc'                      ## *****
    return filePath

def writeFilepath(var,src_id,exp_id,var_lbl,ys,ye):
    filePath = 'procData/DAmip/'+src_id+'/' + var_name2[var]+'_'+'day'+'_'+src_id+'_'+ exp_id+'_'+ var_lbl+'_'+str(ys)+'-'+str(ye)+'.nc'                         ## *****
    return filePath

def writeFilepath2(var,src_id,exp_id,var_lbl,ys,ye):
    filePath = 'procData/DAmip/'+src_id+'/' + var +'_'+'day'+'_'+src_id+'_'+ exp_id+'_'+ var_lbl+'_'+str(ys)+'-'+str(ye)+'.nc'                                   ## *****
    return filePath
...
def getFilepath_pr(src_id,exp_id,var_lbl):
    filePath = 'rawData/forcings/'+src_id+'/pr_day_' + src_id + '_' + exp_id + '_' + var_lbl + '_gn_19500101-20141231.nc'
    return filePath

def getFilepath_tas(src_id,exp_id,var_lbl):
    filePath = 'rawData/forcings/'+src_id+'/tas_day_' + src_id + '_' + exp_id + '_' + var_lbl + '_gn_19500101-20141231.nc'
    return filePath
