...
def get_omega_aveTime():
    ...
    wap_alltime_cond_wp      = 'procData/historical/'+'wap_alltime_cond_'+src_id + '_' + exp_id + '_' + var_lbl+'_'+str(yearS[0])+'-'+str(yearE[-1])+'.nc'
    ...
    wap_avgtime_cond_wp      = 'procData/historical/'+'wap_avgtime_cond_'+src_id + '_' + exp_id + '_' + var_lbl+'_'+str(yearS[0])+'-'+str(yearE[-1])+'.nc'
...
src_id   = 'MPI-ESM1-2-HR'                                                                                                                                 ## *****
exp_id   = 'historical' #['historical','hist-aer','hist-GHG','hist-nat','piControl','ssp585']                                                             ## *****
var_lbl  = 'r1i1p1f1'                                                                                                                                   ## *****
grid_lbl = 'gn'
...
def getFilepath1(var,src_id,exp_id,var_lbl,grid_lbl,ys,ye):
    filePath = 'rawData/' + var_name[var]+'_'+freq[var]+'_'+src_id+'_'+ exp_id+'_'+ var_lbl+'_'+grid_lbl+'_'+str(ys)+'0101-'+str(ye)+'1231.nc'
    return filePath

def getFilepath2(var,src_id,exp_id,var_lbl,grid_lbl):
    filePath = 'rawData/' + var_name[var]+'_'+freq[var]+'_'+src_id+'_'+ exp_id+'_'+ var_lbl+'_'+grid_lbl+'_'+'195001-'+'201412.nc'                      ## *****
    return filePath

def writeFilepath(var,src_id,exp_id,var_lbl,ys,ye):
    filePath = 'procData/historical/' + var_name2[var]+'_'+'day'+'_'+src_id+'_'+ exp_id+'_'+ var_lbl+'_'+str(ys)+'-'+str(ye)+'.nc'                         ## *****
    return filePath

def writeFilepath2(var,src_id,exp_id,var_lbl,ys,ye):
    filePath = 'procData/historical/' + var +'_'+'day'+'_'+src_id+'_'+ exp_id+'_'+ var_lbl+'_'+str(ys)+'-'+str(ye)+'.nc'                                   ## *****
    return filePath
...
def getFilepath_pr(src_id,exp_id,var_lbl):
    filePath = 'rawData/pr_day_' + src_id + '_' + exp_id + '_' + var_lbl + '_gn_19500101-20141231.nc'
    return filePath

def getFilepath_tas(src_id,exp_id,var_lbl):
    filePath = 'rawData/tas_day_' + src_id + '_' + exp_id + '_' + var_lbl + '_gn_19500101-20141231.nc'
    return filePath
