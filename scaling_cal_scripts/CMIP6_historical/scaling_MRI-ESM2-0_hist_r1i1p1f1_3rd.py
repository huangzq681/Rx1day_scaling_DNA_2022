...
var_lbl  = 'r1i1p1f1'                                                                                                                                   ## *****
grid_lbl = 'gn'
yearS    = [i*10+1950 for i in range(7)]
yearE    = [i*10+1959 for i in range(6)] + [2014]
...
def getFilepath2(var,src_id,exp_id,var_lbl,grid_lbl):
    filePath = 'rawData/' + var_name[var]+'_'+freq[var]+'_'+src_id+'_'+ exp_id+'_'+ var_lbl+'_'+grid_lbl+'_'+'185001-'+'201412.nc'                      ## *****
    return filePath
